...
bool	Account::makeWithdrawal(int withdrawal)
{
	...
	{
		_displayTimestamp();
		std::cout << "index:" << this->_accountIndex << ";p_amount:" << this->_amount << ";withdrawal:refuesd" << std::endl;
		return (false);
	}
...
{
	_dispayTimestamp();
	std::cout << " index:" << this->accountIndex << ";amount:"
		<< this->amount << ";" << "deposits:" << this->_nbDeposits
		<< ";withdrawals:" << this->_nbWithdrawals << std::endl;
}

Account::Account(int initial_deposit)
{
	this->_amount = initial_despoit;
	...
	_displayTimestamp();
	std::out << " index:" << this->_accountIndex << ";amount:"
